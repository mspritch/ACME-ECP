...
set np = 2176 # add 7 cores to get close to KNL limit, to reduce pcol by 1/8
set job_name       = ne16_production_test_np${np}_512x_imbalance
...
set nother         = $np
### GRID OPTIONS <Liran>
# CRM 1 -- standard SP 32 x 4km, 20 s
#
...
# CRM 2 -- UP but not ambitious enough 1024 x 250m, 2.5s
...
set crm_nz2        = 58
set nlev           = 72
# Implied work ratio is (2048/32)*(20/2.5) = 512x 
...
set cam_opt = "-phys cam5 -use_SPCAM  -rad rrtmg -nlev $nlev -microphys mg2  -crm_nz $crm_nz -crm_nz2 $crm_nz2 -crm_adv MPDATA -crm_dt $crm_nt  -crm_nx $crm_nx -crm_ny $crm_ny -crm_dx $crm_dx  -crm_nx_rad 1 -crm_ny_rad 1 -crm_dt2 $crm_nt2  -crm_nx2 $crm_nx2 -crm_ny2 $crm_ny2 -crm_dx2 $crm_dx2  -crm_nx_rad2 1 -crm_ny_rad2 1 -bc_dep_to_snow_updates  -SPCAM_microp_scheme sam1mom -chem none  -cppdefs  -DSP_MCICA_RAD -pcols $npcol  -aquaplanet "
...
else if ( $machine == stampede2-knl-liran || $machine == stampede2-knl ) then
