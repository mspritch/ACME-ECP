...
set job_name       = STest_nx8_ny1_dx1000_nt5_nz58_timmer
...
set input_data_dir = '/work/07088/tg863871/stampede2/inputdata' # pritch, using Liran's predownloaded input data
...
cat <<EOF >> user_nl_cam
 ...
 fincl2 = 'FLUT','U200','U850','PRECT','OMEGA500','TGCLDLWP','TGCLDIWP','TIMINGIN','TIMINGEX'
EOF
...
else if ( $machine == stampede2-knl || $machine == stampede2-knl-liran ) then
    e3sm_print "Setup stampede2-knl machine"
