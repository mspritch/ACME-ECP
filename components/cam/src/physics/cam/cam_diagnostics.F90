...
!-- mdb spcam
  ...
  call phys_getopts(use_ECPP_out  = use_ECPP)
   ...
   if (use_SPCAM) then
      ...
      call addfld ('TIMINGIN ', horiz_only, 'A', '        ','Internal CRM CPU usage efficiency: 1 - ideal'     )
      call addfld ('TIMINGEX ', horiz_only, 'A', '        ','External CRM CPU usage efficiency: 1 - ideal'     )
      ...
      call add_default ('TIMINGIN', 1, ' ')
      call add_default ('TIMINGEX', 1, ' ')
